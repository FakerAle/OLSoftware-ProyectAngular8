...
var routes = [
    { path: 'admin', loadChildren: function () { return __webpack_require__.e(/*! import() | components-admin-admin-module */ "components-admin-admin-module").then(__webpack_require__.bind(null, /*! ./components/admin/admin.module */ "./src/app/components/admin/admin.module.ts")).then(function (m) { return m.AdminModule; }); } },
    { path: 'login', loadChildren: function () { return Promise.all(/*! import() | components-auth-login-login-module */[__webpack_require__.e("common"), __webpack_require__.e("components-auth-login-login-module")]).then(__webpack_require__.bind(null, /*! ./components/auth/login/login.module */ "./src/app/components/auth/login/login.module.ts")).then(function (m) { return m.LoginModule; }); } },
    { path: 'home', loadChildren: function () { return Promise.all(/*! import() | components-pages-home-home-module */[__webpack_require__.e("common"), __webpack_require__.e("components-pages-home-home-module")]).then(__webpack_require__.bind(null, /*! ./components/pages/home/home.module */ "./src/app/components/pages/home/home.module.ts")).then(function (m) { return m.HomeModule; }); } },
    {
        path: '',
        redirectTo: 'login',
        pathMatch: 'full'
...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.obtenerUsuarios = function () {
        return this.collectionUsers
            .snapshotChanges()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
            return actions.map(function (a) {
                var data = a.payload.doc.data();
                var idFireBase = a.payload.doc.id;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ idFireBase: idFireBase }, data);
            });
        }));
    };
    PostService.prototype.guardarFireBase = function (post) {
        var postObj = {
            nombre: post.nombre,
    ...
    PostService.prototype.eliminarUsuario = function (id) {
...
var ModalComponent = /** @class */ (function () {
    function ModalComponent(dialog, servicioFireBase, data) {
        this.dialog = dialog;
    ...
    ModalComponent.prototype.addNewPost = function (usuario) {
        console.log(usuario);
