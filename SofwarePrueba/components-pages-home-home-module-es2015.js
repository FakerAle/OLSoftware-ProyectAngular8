...
const routes = [{ path: '', component: _home_component__WEBPACK_IMPORTED_MODULE_3__["HomeComponent"], canActivate: [_shared_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]] }];
...
let TableComponent = class TableComponent {
    constructor(servicioFireBase, dialog) {
...
let AuthGuard = class AuthGuard {
    ...
    canActivate() {
        return this.authSvc.userData.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(user => {
            if (!user) {
